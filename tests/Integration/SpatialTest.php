...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function test_insert_point()
    {
    ...
    public function test_insert_line_string()
    {
        $geo = new GeometryModel;
    ...
    public function test_insert_polygon()
    {
        $geo = new GeometryModel;
    ...
    public function test_insert_multi_point()
    {
        $geo = new GeometryModel;
    ...
    public function test_insert_multi_polygon()
    {
        $geo = new GeometryModel;
    ...
    public function test_insert_geometry_collection()
    {
        $geo = new GeometryModel;
    ...
    public function test_insert_empty_geometry_collection()
    {
        $geo = new GeometryModel;
    ...
    public function test_distance_sphere()
    {
        $loc1 = new GeometryModel;
    ...
    public function test_distance_value()
    {
        $loc1 = new GeometryModel;
        $loc1->location = new Point(1, 1);
        $loc1->save();
    ...
    public function test_distance_sphere_value()
    {
        $loc1 = new GeometryModel;
        $loc1->location = new Point(40.767864, -73.971732);
        $loc1->save();
    ...
    public function test_order_by_spatial_with_unknown_function()
    {
        $loc = new GeometryModel;
        $loc->location = new Point(1, 1);

        $this->assertException(\Habib\LaravelSpatial\Exceptions\UnknownSpatialFunctionException::class);
        GeometryModel::orderBySpatial('location', $loc->location, 'does-not-exist')->get();
    }

    public function test_order_by_distance()
    {
        $loc2 = new GeometryModel;
        $loc2->location = new Point(2, 2); // Distance from loc1: 1.4142135623731
        $loc2->save();
    ...
    public function test_order_by_distance_sphere()
    {
        $loc2 = new GeometryModel;
        $loc2->location = new Point(40.767664, -73.971271); // Distance from loc1: 44.741406484588
        $loc2->save();
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \Habib\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \Habib\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \Habib\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
