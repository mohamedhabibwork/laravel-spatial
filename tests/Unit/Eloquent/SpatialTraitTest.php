...
class SpatialTraitTest extends BaseTestCase
{
    ...
    public function test_insert_update_line_string_has_correct_sql()
    {
        ...
        $this->model->linestring = new \Habib\LaravelSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function test_insert_update_polygon_has_correct_sql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Habib\LaravelSpatial\Types\LineString([$point1, $point2]);
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $linestring2 = new \Habib\LaravelSpatial\Types\LineString([$point3, $point4]);

        $this->assertFalse($this->model->exists);

        $this->model->polygon = new \Habib\LaravelSpatial\Types\Polygon([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function test_insert_update_multi_point_has_correct_sql()
    {
        ...
        $this->model->multipoint = new \Habib\LaravelSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function test_insert_update_multi_line_string_has_correct_sql()
    {
        ...
        $this->model->multilinestring = new \Habib\LaravelSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function test_insert_update_multi_polygon_has_correct_sql()
    {
        ...
        $point4 = new Point(2, 1);
        $linestring2 = new \Habib\LaravelSpatial\Types\LineString([$point3, $point4]);
        $polygon1 = new \Habib\LaravelSpatial\Types\Polygon([$linestring1, $linestring2]);

        $point5 = new Point(4, 5);
        $point6 = new Point(5, 6);
        $linestring3 = new \Habib\LaravelSpatial\Types\LineString([$point5, $point6]);
        $point7 = new Point(6, 5);
        $point8 = new Point(5, 4);
        $linestring4 = new \Habib\LaravelSpatial\Types\LineString([$point7, $point8]);
        $polygon2 = new \Habib\LaravelSpatial\Types\Polygon([$linestring3, $linestring4]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Habib\LaravelSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function test_insert_update_geometry_collection_has_correct_sql()
    {
        ...
        $linestring1 = new \Habib\LaravelSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Habib\LaravelSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
    ...
    public function test_scope_distance()
    {
        ...
        $this->assertInstanceOf(\Habib\LaravelSpatial\Eloquent\Builder::class, $query);
        $q = $query->getQuery();
    ...
    private function buildTestPolygon()
    {
        ...
        return new \Habib\LaravelSpatial\Types\Polygon([$linestring1, $linestring2, $linestring3]);
    }
    ...
    public function test_scope_order_by_spatial_throws_exception_when_function_not_registered()
    {
        $point = new Point(1, 2);
        $this->assertException(
            \Habib\LaravelSpatial\Exceptions\UnknownSpatialFunctionException::class,
            'does-not-exist'
        );
