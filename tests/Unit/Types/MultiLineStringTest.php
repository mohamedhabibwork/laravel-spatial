...
use Habib\LaravelSpatial\Types\MultiLineString;
...
class MultiLineStringTest extends BaseTestCase
{
    ...
    public function test_invalid_argument_exception_at_least_one_entry()
    {
        $this->assertException(
            ...
            'Habib\LaravelSpatial\Types\MultiLineString must contain at least 1 entry'
        );
    ...
    public function test_invalid_argument_exception_not_array_of_line_string()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'Habib\LaravelSpatial\Types\MultiLineString must be a collection of Habib\LaravelSpatial\Types\LineString'
        );
        $multilinestring = new MultiLineString([
