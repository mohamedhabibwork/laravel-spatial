...
class MultiPolygonTest extends BaseTestCase
{
    ...
    public function test_invalid_argument_exception_at_least_one_entry()
    {
        $this->assertException(
            ...
            'Habib\LaravelSpatial\Types\MultiPolygon must contain at least 1 entry'
        );
    ...
    public function test_invalid_argument_exception_not_array_of_polygon()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'Habib\LaravelSpatial\Types\MultiPolygon must be a collection of Habib\LaravelSpatial\Types\Polygon'
        );
        $multipolygon = new MultiPolygon([
            $this->getPolygon1(),
            $this->getLineString1(),
